...
**DoctisAImo v12.0 (RAG-Integrated)** est une solution de **Triage Médical Intelligent** de nouvelle génération.
...
*Si tout fonctionne, vous verrez : `✅ Agent Chargé : DoctisAImo v12.0-RAG`.*
